...
- `neptune_token` (String, Sensitive) The Neptune API token. Can be taken from User or a Service Account. Can also be provided via NEPTUNE_API_TOKEN environment variable.
- `timeout` (Number) The timeout for the Neptune API client
- `workspace` (String) The Neptune workspace name. Can also be provided via NEPTUNE_WORKSPACE environment variable.
