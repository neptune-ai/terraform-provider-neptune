...
page_title: "neptune_project Data Source - neptune"
subcategory: ""
description: |-
  Neptune project data source
---

# neptune_project (Data Source)
...
- `id` (String) Project identifier (UUID). Either `id` or `project_name` must be specified.
- `project_name` (String) Project name for lookup. Either `id` or `project_name` must be specified.
...
- `visibility` (String) Project visibility: `priv` (private), `pub` (public), or `workspace` (workspace)
